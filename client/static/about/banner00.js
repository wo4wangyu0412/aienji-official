...
/*banner*/
var banner00=new change();

    banner00.position=function(){
        change().position.call(this);
        if(this.data["position_style"]=="banner00"){
    ...
    banner00.todo=function(data){
        ...
        if(this.data["position_style"]=="banner00"){
            ...
            $(this.data["element"]+":eq("+this.data["index"]+")").stop(false,true).addClass("in").css({"left":-direc*this.data["position_width"]+"px"}).animate({"left":"0px"},500,function(){banner00.data["todo_bool"]=false;});
            
        }
    }
    banner00.init({
        "parent_move_element":".banner00",
        "element":".banner00 .content00",
        "position_style":"banner00",
        "autoplay":true,
        "autoplay_time":5000,
        "btn":'<div class="child00"></div>',
        "btn_function":"banner00",
        "btn_parent":".banner00 .banner-nav"
    });
/*
*   by dong
*   http://www.dydong.com 
